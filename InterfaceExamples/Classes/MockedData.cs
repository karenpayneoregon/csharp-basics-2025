...
internal class MockedData
{
    ...
    internal static List<IPerson> ClientPersons
        =>
        [
            new Client { Id = 1, FirstName = "Alice", LastName = "Johnson", Gender = Gender.Female, Active = false},
            new Client { Id = 2, FirstName = "Bob", LastName = "Smith", Gender = Gender.Male, Active = true},
